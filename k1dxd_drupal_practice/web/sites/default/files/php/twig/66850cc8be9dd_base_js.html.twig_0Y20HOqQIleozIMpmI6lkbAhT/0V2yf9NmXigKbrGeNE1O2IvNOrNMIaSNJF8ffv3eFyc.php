...
class __TwigTemplate_6e998a3bbb2c0e336c36604275d7c6c5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((array_key_exists("csp_script_nonce", $context) && ($context["csp_script_nonce"] ?? null))) {
            yield " nonce=\"";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["csp_script_nonce"] ?? null), 3, $this->source), "html", null, true);
            yield "\"";
        }
        yield ">/*<![CDATA[*/
  ";
      ...
      ";
        ...
        window.fetch = function () {
          ...
          if (!url.match(new RegExp(";
            // line 312
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(json_encode($this->sandbox->ensureToStringAllowed(($context["excluded_ajax_paths"] ?? null), 312, $this->source)));
            yield "))) {
            var method = 'GET';
      ...
      if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
        ...
        XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
          ...
          if (url.substr(0, 1) === '/') {
            if (0 === url.indexOf('";
            // line 355
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 355), 355, $this->source), "js"), "html", null, true);
            yield "')) {
              path = url.substr(";
            // line 356
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 356), 356, $this->source)), "html", null, true);
            yield ");
            }
          }
          else if (0 === url.indexOf('";
            // line 359
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, true, 359), 359, $this->source) . $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 359), 359, $this->source)), "js"), "html", null, true);
            yield "')) {
            path = url.substr(";
            // line 360
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::length($this->env->getCharset(), ($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, true, 360), 360, $this->source) . $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 360), 360, $this->source))), "html", null, true);
            yield ");
          }

          if (!path.match(new RegExp(";
            // line 363
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(json_encode($this->sandbox->ensureToStringAllowed(($context["excluded_ajax_paths"] ?? null), 363, $this->source)));
            yield "))) {
            var stackElement = {
              error: false,
              url: url,
      ...
      return {
        ...
        loadToolbar: function(token, newToken) {
          ...
          this.load(
            ...
            '";
        // line 554
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("webprofiler.toolbar", ["token" => "xxxxxx"]), "js"), "html", null, true);
        ...
        // line 638
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("<front>"), "js"), "html", null, true);
        yield "' + newToken + '>Open the Webprofiler.</a>\\
                                </div>\\
                            ';
...
";
    ...
    {
        return array (  711 => 638,  624 => 554,  460 => 392,  428 => 363,  422 => 360,  418 => 359,  412 => 356,  408 => 355,  362 => 312,  341 => 293,  339 => 292,  52 => 7,  43 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("", "@webprofiler/Profiler/base_js.html.twig", "/opt/drupal/web/modules/contrib/webprofiler/templates/Profiler/base_js.html.twig");
    }
